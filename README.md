...
*******************************************************************************
Yes. Our kernels are currently based on 6.8/6.14
...
*******************************************************************************
`shim_16.1-1+pmx1~bpo12+1_amd64.build` (build log)
`shim_16.1-1+pmx1~bpo12+1_amd64.buildinfo` (versions of packages installed in the build environment)
...
449c96080424fc805f394ba9a1b15a5518865ded9ee92359795f5bb568cbff99  shimx64.efi
...
*******************************************************************************
 ...
 gcry_sha256 gcry_sha512 gcry_tiger gcry_twofish gcry_whirlpool gettext gfxmenu
 gfxterm gfxterm_background gzio halt help hfsplus iso9660 jfs jpeg keystatus
 linux linuxefi loadenv loopback ls lsefi lsefimmap lsefisystab lssal luks
 luks2 lvm mdraid09 mdraid1x memdisk minicmd normal part_apple part_gpt
 part_msdos password_pbkdf2 play png probe raid5rec raid6rec reboot regexp
 search search_fs_file search_fs_uuid search_label serial sleep smbios squash4
 test tpm true video xfs zfs zfscrypt zfsinfo
...
*******************************************************************************
Based on Debian Bookworm's 2.06-13, packaged as 2.06-13+pmx7
...
*******************************************************************************
Currently 6.8.x and 6.14.x as base (both based on the corresponding Ubuntu
kernel series).
...
- https://git.proxmox.com/?p=pve-kernel.git;a=tree;h=refs/heads/bookworm-6.14;hb=refs/heads/bookworm-6.14
- https://git.proxmox.com/?p=pve-kernel.git;a=tree;h=refs/heads/bookworm-6.8;hb=refs/heads/bookworm-6.8
...
A very similar submission for our Trixie based releases was submitted in
parallel in #524
